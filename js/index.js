// When the page loads, check if the user has a saved theme
...
function PhoneNavbarOptionsToggler() {
  ...
  if (phoneOptions.style.display === "none") {
    ...
    githubDisplayName.style.display = "none";
    githubBio.style.display = "none";
    github_PublicRepos.style.display = "none";
    github_Company.style.display = "none";
    github_Email.style.display = "none";
    github_Location.style.display = "none";
    github_hireable.style.display = "none";
    github_followers.style.display = "none";
    github_Following.style.display = "none";
...
async function GithubInfo() {
  ...
  try {
    ...
    githubDisplayName.classList.add("animate");
    githubBio.classList.add("animate");
    github_PublicRepos.classList.add("animate");
    github_Company.classList.add("animate");
    github_Email.classList.add("animate");
    github_Location.classList.add("animate");
    github_hireable.classList.add("animate");
    github_followers.classList.add("animate");
    github_Following.classList.add("animate");
    ...
    github_Location.innerText = `Location: ${data.location}` || "No Location";
    github_hireable.innerText = `Hireable: ${data.hireable}` || "Not hireable";
    ...
    setTimeout(() => {
      ...
      githubDisplayName.classList.remove("animate");
      githubBio.classList.remove("animate");
      github_PublicRepos.classList.remove("animate");
      github_Company.classList.remove("animate");
      github_Email.classList.remove("animate");
      github_Location.classList.remove("animate");
      github_hireable.classList.remove("animate");
      github_followers.classList.remove("animate");
      github_Following.classList.remove("animate");
    }, 2000);
